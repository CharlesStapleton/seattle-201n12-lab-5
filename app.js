...
function multiply(a, b) { //eslint-disable-line
  var multipled = a * b;
  var concatenated = 'The product of ' + a + ' and ' + b + ' is ' + multipled + '.';
...
function sumArray(testArray) { //eslint-disable-line
  var sumNumbers = sum(testArray[0], testArray[1])[0];
  sumNumbers = sum(sumNumbers, testArray[2]);

  var sumArrayString = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sumNumbers[0] + ' is their sum.';
...
function multiplyArray(testArray) { //eslint-disable-line
  var multNumbers = multiply(testArray[0], testArray[1])[0];
  multNumbers = multiply(multNumbers, testArray[2]);

  var multArrayString = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of 24.';
